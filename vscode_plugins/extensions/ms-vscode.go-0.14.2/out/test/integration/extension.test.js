...
suite('Go Extension Tests', function () {
    ...
    suiteSetup(() => __awaiter(this, void 0, void 0, function* () {
        ...
        fs.copySync(path.join(fixtureSourcePath, 'importTest', 'cgoImports.go'), path.join(fixturePath, 'importTest', 'cgoImports.go'));
...
`;
    ...
    test('Add imports and avoid pseudo package imports for cgo', () => __awaiter(this, void 0, void 0, function* () {
